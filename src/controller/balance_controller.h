...
public:
    std::string getPrefix() const override { return "/api/balance"; }

    void registerRoutes(crow::SimpleApp& app) override {
        // Get my balance and transactions
        ...
        // Admin: view specific user balance
        ...
        // User self-service deposit (any authenticated user)
